...
exports = module.exports = function (config, webpackIsomorphicTools) {
  ...
  var webpackConf = {
    ...
    entry: {
      'main': ['webpack-hot-middleware/client?path=http://' + host + ':' + port + '/__webpack_hmr', 'bootstrap-loader', 'font-awesome-loader!' + path.resolve(config.appConfig.app.themePath, config.appConfig.app.theme, 'font-awesome.config.js'), '' + path.resolve(config.appConfig.app.startScript)]
    },
    output: {
      path: assetsPath,
    ...
    plugins: [new Webpack.HotModuleReplacementPlugin(), new HappyPack({
      id: 'javascript',
      ...
      failOnError: true
    }), new ExtractTextPlugin({ filename: '[name]-[chunkhash].css', disable: false, allChunks: true }), new Webpack.DefinePlugin({
      __CLIENT__: true,
      __SERVER__: false,
      ...
      debug: true
    }), new Webpack.IgnorePlugin(/webpack-stats\.json$/), webpackIsomorphicToolsPlugin.development()]
  };
