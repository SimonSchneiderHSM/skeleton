...
var CreateParallelGatewayMutation = (_temp = _class = function (_Relay$Mutation) {
    (0, _inherits3.default)(CreateParallelGatewayMutation, _Relay$Mutation);

    function CreateParallelGatewayMutation() {
        (0, _classCallCheck3.default)(this, CreateParallelGatewayMutation);
        return (0, _possibleConstructorReturn3.default)(this, (CreateParallelGatewayMutation.__proto__ || Object.getPrototypeOf(CreateParallelGatewayMutation)).apply(this, arguments));
    }

    (0, _createClass3.default)(CreateParallelGatewayMutation, [{
        key: 'getMutation',
        value: function getMutation() {
            return function () {
                return {
                    ...
                    kind: 'Mutation',
                    metadata: {
                        inputType: 'CreateParallelGatewayInput!'
                    },
                    name: 'CreateParallelGatewayMutation',
                    responseType: 'CreateParallelGatewayPayload'
                };
            }();
        }
    }, {
        ...
        value: function getFatQuery() {
            return function () {
                return {
                    ...
                    kind: 'Fragment',
                    metadata: {},
                    name: 'CreateParallelGatewayMutation_ValueRelayQL',
        ...
        value: function getOptimisticResponse() {
            var _props = this.props,
                ...
                parallelType = _props.parallelType,
    ...
    return CreateParallelGatewayMutation;
    ...
    catalog: function catalog() {
        return function () {
            return {
                ...
                kind: 'Fragment',
                metadata: {},
                name: 'CreateParallelGatewayMutation_CatalogRelayQL',
                type: 'Catalog'
            };
        }();
    }
}, _temp);
exports.default = CreateParallelGatewayMutation;
