...
var UdpateThrowEventMutation = (_temp = _class = function (_Relay$Mutation) {
    (0, _inherits3.default)(UdpateThrowEventMutation, _Relay$Mutation);

    function UdpateThrowEventMutation() {
        (0, _classCallCheck3.default)(this, UdpateThrowEventMutation);
        return (0, _possibleConstructorReturn3.default)(this, (UdpateThrowEventMutation.__proto__ || Object.getPrototypeOf(UdpateThrowEventMutation)).apply(this, arguments));
    }

    (0, _createClass3.default)(UdpateThrowEventMutation, [{
        key: 'getMutation',
        value: function getMutation() {
            return function () {
                return {
                    ...
                    kind: 'Mutation',
                    metadata: {
                        inputType: 'UpdateThrowEventInput!'
                    },
                    name: 'UpdateThrowEventMutation',
                    responseType: 'UpdateThrowEventPayload'
                };
            }();
        }
    }, {
        ...
        value: function getFatQuery() {
            return function () {
                return {
                    ...
                    kind: 'Fragment',
                    metadata: {},
                    name: 'UpdateThrowEventMutation_ValueRelayQL',
    ...
    return UdpateThrowEventMutation;
    ...
    catalog: function catalog() {
        return function () {
            return {
                ...
                kind: 'Fragment',
                metadata: {},
                name: 'UpdateThrowEventMutation_CatalogRelayQL',
                type: 'Catalog'
            };
        }();
    },
    throwevent: function throwevent() {
        return function () {
            return {
                ...
                kind: 'Fragment',
                metadata: {},
                name: 'UpdateThrowEventMutation_ThroweventRelayQL',
                type: 'ThrowEvent'
            };
        }();
    }
}, _temp);
exports.default = UdpateThrowEventMutation;
