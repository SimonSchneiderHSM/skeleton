import {ExecutionContext, SchemaAttributeType, IInheritedSchema, IEntity} from '@process-engine-js/core_contracts';
import {IDataModel, Entity, EntityDependencyHelper} from '@process-engine-js/data_model_contracts';
import {IReservationEntityTypeService, IReservationEntity} from '../interfaces';
